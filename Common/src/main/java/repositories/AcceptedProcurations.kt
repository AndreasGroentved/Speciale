...
class AcceptedProcurations {
    ...
    init {
        ...
        saveProcuration(Procuration("abc", "hest", BigInteger("165615760792845808078562255657443417455825412085455006148620929027491723303411487844979141873745096637953045819064779313008630684872882194634243766937424079829"), Date(), Date(1553523307558)))
    }
